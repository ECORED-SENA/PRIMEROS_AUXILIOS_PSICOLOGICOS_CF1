    ...
    .row.justify-content-center.mb-5
      ...
      .col-lg-8
        LineaTiempoD.color-primario
          ...
          p.mb-0(numero="3" titulo="Género, edad y relaciones de poder") Dependiendo del tipo de cultura la edad y el género marcan formas de relación; por ejemplo, mujeres a las cuales solo las pueden auxiliar mujeres, o personas mayores que no aceptan ayuda de personas de menor edad. En este mismo sentido las relaciones de poder marcan también el acercamiento, por tanto, es necesario cuestionarse sobre los siguiente:
          ...
          p.mb-0(numero="6" titulo="Creencias y religión") Este es tal vez uno de los puntos álgidos a la hora de acercarse a la persona afectada. Algunas religiones no permiten que se preste ayuda, otras no permiten que se hable de la crisis o el dolor. Como cuestionamientos se sugieren: ¿qué prácticas son importantes para esta persona? cuál es su religión y qué restricciones podría tener para prestar el apoyo?
